...
import com.crossoverjie.cim.wsserver.util.JsonUtils;
...
//        User loginUser = (User) session.getAttribute(Constants.SESSION_USER);
        ...
        HelloMessage resultData = new HelloMessage(MessageFormat.format("{0} say: {1}", sender, msg));
        //this.sendToUser(loginUser.getUsername(), receiver, "/topic/reply", JsonUtils.toJson(resultData));
        this.sendToUser(sender, receiver, "/topic/reply", JsonUtils.toJson(resultData));
